...
@Composable
fun viewModelComposable(parentStatus: String, modifier: Modifier = Modifier, myViewModel: MyViewModel = getViewModel { parametersOf(parentStatus) }) {
    var created by remember { mutableStateOf(false) }

    if (created) {
        clickComponent("ViewModel", myViewModel.hashCode().toString(), parentStatus) {
